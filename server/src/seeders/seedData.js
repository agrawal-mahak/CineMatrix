...
const connectDB = async () => {
  await mongoose.connect(
    process.env.MONGO_URI || "mongodb://127.0.0.1:27017/cinematrix",
  );
};
    ...
    const movies = await Movie.insertMany([
      {
        ...
        description:
          "A mind-bending sci-fi thriller exploring the deep layers of subconscious reality and dream extraction.",
        duration: 148,
      ...
      },
      {
        ...
        description:
          "In a futuristic neon city, a rogue hacker uncovers a high-stakes AI conspiracy that threatens humanity.",
        duration: 132,
      ...
      },
      {
        ...
        description:
          "An inspiring musical romantic journey across Paris and Tokyo between two passionate street musicians.",
        duration: 118,
      ...
      },
      {
        ...
        description:
          "An epic fantasy blockbuster following a brave band of warriors battling dark magical warlords.",
        duration: 165,
    ...
    await Review.insertMany([
      {
        ...
        comment:
          "Mind-bending visuals, astonishing sound design, and unmatched storytelling. Must watch in IMAX 3D!",
        likes: 14,
      },
      {
        movieId: movies[0]._id,
        ...
        comment:
          "The background score gives goosebumps! Easily the best sci-fi film of the decade.",
        likes: 9,
      },
      {
        ...
        comment:
          "Great world-building and neon aesthetics. High energy throughout!",
        likes: 5,
      },
    ]);
